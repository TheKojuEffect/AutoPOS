(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('category', {
            ...
            views: {
                'content-tab': {
                    templateUrl: 'app/catalog/category/categories.html',
        ...
        .state('category-detail', {
            ...
            views: {
                'content-tab': {
                    templateUrl: 'app/catalog/category/category-detail.html',
        ...
        .state('category.new', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/catalog/category/category-dialog.html',
        ...
        .state('category.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/catalog/category/category-delete-dialog.html',
