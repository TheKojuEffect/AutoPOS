...
//    }
    ...
    private fun initMetrics(servletContext: ServletContext, disps: EnumSet<DispatcherType>) {
        ...
        val metricsFilter: FilterRegistration.Dynamic = servletContext.addFilter("webappMetricsFilter", InstrumentedFilter())
        metricsFilter.addMappingForUrlPatterns(disps, true, "/*")
        metricsFilter.setAsyncSupported(true)
        log.debug("Registering Metrics Servlet")
        val metricsAdminServlet: ServletRegistration.Dynamic = servletContext.addServlet("metricsServlet", MetricsServlet())
