...
import { AposHealthCheckComponent } from '../../../../../../main/webapp/app/admin/health/health.component';
import { AposHealthService } from '../../../../../../main/webapp/app/admin/health/health.service';


describe('Component Tests', () => {

    describe('AposHealthCheckComponent', () => {

        let comp: AposHealthCheckComponent;
        let fixture: ComponentFixture<AposHealthCheckComponent>;
        let service: AposHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [AutoPosTestModule],
                declarations: [AposHealthCheckComponent],
                providers: [
                    AposHealthService,
                    {
                        provide: NgbModal,
            ...
            .overrideComponent(AposHealthCheckComponent, {
                set: {
                    template: ''
                }
            })
        ...
        beforeEach(() => {
            fixture = TestBed.createComponent(AposHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(AposHealthService);
        });
