...
public class ItemResourceIntTest {
    ...
    public void createItem() throws Exception {
        ...
        assertThat(testItem.getPartNumber()).isEqualTo(DEFAULT_PART_NUMBER);
        ...
        assertThat(testItem.getLocation()).isEqualTo(DEFAULT_LOCATION);
    ...
    public void updateItem() throws Exception {
        ...
        assertThat(testItem.getPartNumber()).isEqualTo(UPDATED_PART_NUMBER);
        ...
        assertThat(testItem.getLocation()).isEqualTo(UPDATED_LOCATION);
